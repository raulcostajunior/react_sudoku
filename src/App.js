                        ...
                        <div className="row">
                            <div className="col">
                                <table style={{ fontSize: 'smaller', marginTop: '1em', marginBottom: '1em' }}>
                                    <tbody>
                                        <tr>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderTop: '2px solid gray', borderLeft: '2px solid gray' }}>1</td>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderTop: '2px solid gray' }}>2</td>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderTop: '2px solid gray', borderRight: '2px solid gray' }}>3</td>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderTop: '2px solid gray' }}>4</td>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderTop: '2px solid gray' }}>5</td>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderTop: '2px solid gray', borderRight: '2px solid gray' }}>6</td>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderTop: '2px solid gray' }}>7</td>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderTop: '2px solid gray' }}>8</td>
                                            <td style={{ padding: '8px', margin: '0', textAlign: 'center', border: '1px solid lightGray', borderRight: '2px solid gray', borderTop: '2px solid gray' }}>9</td>
                                        </tr>
                                        <tr style={{ border: '1px solid lightGray' }}>
